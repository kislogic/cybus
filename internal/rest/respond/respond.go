...
// InternalServerError returns a 500 Internal Host Error JSON response
...
func (r *Responder) TooManyRequests(w http.ResponseWriter, v interface{}) {
	r.writeResponse(w, v, http.StatusTooManyRequests)
}
